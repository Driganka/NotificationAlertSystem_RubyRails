...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference("Developer.count") do
      post developers_url, params: { developer: { devid: @developer.devid, devname: @developer.devname, dptid: @developer.dptid, email: @developer.email, phone: @developer.phone } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { devid: @developer.devid, devname: @developer.devname, dptid: @developer.dptid, email: @developer.email, phone: @developer.phone } }
